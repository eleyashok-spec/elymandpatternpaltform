  ...
  try {
    ...
    console.log("Webhook data received:", { 
      ...
      serve(async (req) => {
        ...
        // Allow GET for IPN URL validation and simple health checks (2Checkout may probe the URL)
        if (req.method === "GET") {
          return new Response(JSON.stringify({ status: "ok", message: "2Checkout webhook endpoint" }), {
            status: 200,
